...
namespace Unity.Physics.Extensions
{
    ...
    public class MouseSpringSystem : JobComponentSystem
    {
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            ComponentDataFromEntity<ObjectSpawner> objectSpawner = GetComponentDataFromEntity<ObjectSpawner>(true);
            ...
            if (springData.Dragging != 0)
            {
                ...
                Debug.Log(TextComponent.GetMessage(entity.Index));
                TextData.SetText(TextComponent.GetMessage(entity.Index));
